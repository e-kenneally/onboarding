...
def get_roi_timeseries(wf_name='roi_timeseries'):
    ...
    timeseries_extract = pe.Node(interface=ciftify.meants(), 
                            input_names=['func', 'seed'], 
                            output_names=['mean_time_series_csv']
    ...
    wflow.connect(timeseries_extract, 'func', 
                  inputNode, 'rest')
    
    wflow.connect(timeseries_extract, 'seed', 
                  timeseries_roi, 'in_file')
    ...
    wflow.connect(timeseries_extract, 'mean_time_series_csv', clean_csv, 'ciftify_csv')
    wflow.connect(clean_csv, 'roi_array', outputNode, 'roi_ts')
    wflow.connect(clean_csv, 'edited_roi_csv', outputNode, 'roi_csv')
    wflow.connect(clean_csv, 'meants_csv', outputNode, 'meants_csv')
